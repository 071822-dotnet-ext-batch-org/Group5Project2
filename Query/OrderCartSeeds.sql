...
INSERT INTO CartsProducts (fk_productID, fk_cartID) VALUES ((SELECT productID FROM Products WHERE productName = 'Umbrella'), 'auth0test2');
INSERT INTO CartsProducts (fk_productID, fk_cartID) VALUES ((SELECT productID FROM Products WHERE productName = 'Jacket'), 'auth0test2');
INSERT INTO CartsProducts (fk_productID, fk_cartID) VALUES ((SELECT productID FROM Products WHERE productName = 'Watch'), 'auth0test2');
INSERT INTO CartsProducts (fk_productID, fk_cartID) VALUES ((SELECT productID FROM Products WHERE productName = 'Jacket'), 'auth0test3');
INSERT INTO CartsProducts (fk_productID, fk_cartID) VALUES ((SELECT productID FROM Products WHERE productName = 'Coffee Table'), 'auth0test3');
